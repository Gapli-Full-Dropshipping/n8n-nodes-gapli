			...
			try {
				...
				// ─── Order ──────────────────────────────────────────────
					...
					if (operation === 'get') {
						...
						// Wynik finansowy dokleja się do KAŻDEGO zamówienia na stronie
						// jednym żądaniem — dlatego to przełącznik przy liście, a nie
						// operacja per zamówienie.
						if (this.getNodeParameter('includeFinancials', i, false) as boolean) {
							qs.include = 'financials';
						}
