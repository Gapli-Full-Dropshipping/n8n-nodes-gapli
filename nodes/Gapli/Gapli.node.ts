			...
			try {
				...
				if (resource === 'product') {
					...
					if (filters.exclude_parser_ids) qs.exclude_parser_ids = filters.exclude_parser_ids;
						...
						const accountId = this.getNodeParameter('sellabilityAccountId', i, 0) as number;
				...
				// ─── Marketplace ─────────────────────────────────────────
					...
					if (operation === 'getAccounts') {
						...
						const accountId = this.getNodeParameter('offerAccountId', i, 0) as number;
				...
				// ─── Duplicate Check ─────────────────────────────────────
					...
					const checkAccountId = this.getNodeParameter('checkAccountId', i, 0) as number;
				...
				// ─── Offer Health ─────────────────────────────────────────
					...
					const healthAccountId = this.getNodeParameter('healthAccountId', i, 0) as number;
				...
				// ─── Allegro Catalog ─────────────────────────────────────
					...
					const catalogAccountId = this.getNodeParameter('catalogAccountId', i) as number;
				...
				// ─── Allegro Listing ─────────────────────────────────────
					...
					const listingAccountId = this.getNodeParameter('listingAccountId', i) as number;
