...
export const orderOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				value: 'get',
				description:
					'Retrieve a single order by its ID. This is the ONLY operation that returns shipments[] with the tracking number and link — Get Many does not contain it.',
...
export const orderFields: INodeProperties[] = [
	...
	{
		displayName:
			'shipments[] comes out here and nowhere else — the tracking number and link a workflow sends back to your own shop are in this response, never in Get Many. ⚠️ Skip entries whose direction is "inbound_from_wholesaler": that leg is wholesaler → GAPLI warehouse, not the parcel to the buyer, and must never be shown to the customer. The buyer\'s parcel has direction "outgoing".',
		name: 'orderShipmentsNotice',
		type: 'notice',
		default: '',
		displayOptions: {
			show: {
