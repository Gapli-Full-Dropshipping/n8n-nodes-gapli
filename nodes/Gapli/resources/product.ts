...
export const productFields: INodeProperties[] = [
	...
	{
		// CELOWO poza kolekcją „Filters".
		//
		// Opcja w kolekcji nie istnieje, dopóki autor przepływu jej nie doda — musiałby
		// więc najpierw WIEDZIEĆ, że jest. Ten filtr ma inną wagę niż reszta: nieustawiony
		// wpuszcza erotykę do oferty budowanej po nazwie i widać to dopiero na żywej
		// aukcji. Na najwyższym poziomie jest widoczny od razu, a przełącznik „niech
		// wypełni model" (`$fromAI`) leży przy nim jednym kliknięciem.
