...
export const analyticsOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Aggregated sales data from completed orders. ⚠️ Use total_revenue_source_currency and total_revenue_pln as primary revenue fields. Fields total_revenue_gross/net are DEPRECATED aliases (source currency / PLN totals, NOT actual gross/net). New fields total_revenue_gross_actual and total_revenue_net_actual contain proper gross/net from order line items.',
