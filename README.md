...
|---|---|
| **Get Many** | Retrieve a list of products from your catalog. Supports filters: parser ID, SKU, search text, EAN/GTIN, availability, price range, stock, oversized, exclude already listed. Full Database Scan mode available. |
