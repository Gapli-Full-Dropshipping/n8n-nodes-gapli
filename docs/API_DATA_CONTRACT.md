...
| `adult_product` | Product flagged as adult/18+ content |
...
| `wholesale_net_price` | PLN | Wholesale purchase net price |
...
| `wholesale_net_price` | number | PLN | Purchase price from wholesaler |
